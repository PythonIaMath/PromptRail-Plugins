...
export const DEFAULT_GRADER_URLS = Object.freeze({
  codex: "https://promptrail--promptrail-colocated-model-thinking-router-v-1877b6.modal.run",
  claude: "https://promptrail--promptrail-colocated-model-thinking-router-v-1877b6.modal.run",
});
