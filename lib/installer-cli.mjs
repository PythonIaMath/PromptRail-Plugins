...
export const DEFAULT_GRADER_URLS = Object.freeze({
  codex: "https://promptrail--promptrail-codex-effort-grader-effortgrader-web.modal.run",
  claude: "https://promptrail--promptrail-claude-effort-grader-claudeeffort-f35715.modal.run",
});
