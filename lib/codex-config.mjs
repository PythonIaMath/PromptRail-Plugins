...
const INFINITE_BASE_INSTRUCTIONS =
  ...
  + "OmniRoute is internal routing infrastructure, not an MCP server or available tool; never discover or call it.";
...
function infiniteProfileConfig(modelCatalogPath) {
  return [
...
export async function upgradeInstalledCodexConfig(
  ...
  const profile = infiniteProfileConfig(modelCatalogPath);
